...
def reset_scene(env: ManagerBasedEnv, env_ids: torch.Tensor):
    ...
    for rigid_object in env.scene.rigid_objects.values():
        ...
        zero_velocity = torch.zeros_like(default_root_state[:, 7:])
        # set into the physics simulation
        rigid_object.write_root_pose_to_sim(default_root_state[:, :7], env_ids=env_ids)
        rigid_object.write_root_velocity_to_sim(zero_velocity, env_ids=env_ids)
    # articulations
    for articulation_asset in env.scene.articulations.values():
        ...
        articulation_asset.write_root_velocity_to_sim(zero_velocity, env_ids=env_ids)
